...
def parserHandler():
    ...
    editParser = subparsers.add_parser("edit", help="Rename or delete elements in pkl file")
    ...
    listParser = subparsers.add_parser("list", help="List all the data in the pkl file")
    listParser.add_argument("-i", type=str, help="pkl file to be displayed")

    splitParser = subparsers.add_parser("split", help="Export certain labels to new .pkl file")
    splitParser.add_argument("-i", type=str, help="Input pkl file")
    splitParser.add_argument("-label", nargs="+", help="Labels to be exported")
    splitParser.add_argument("-e", type=str, help="New pkl file to store splited labels")
...
def splitData(pkl, labels, newpkl):
    df = pd.read_pickle('data.pkl')
    newdf = df[df['Label'].isin(labels)]
    newdf.to_pickle(newpkl)
...
def main():
    ...
    if args.command == 'clean':
        ...
        if not os.path.exists(args.i):
            sys.exit(f'No file named {args.i} exists')
        splitData(args.i, args.label, args.e)
